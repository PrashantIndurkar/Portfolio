    ...
    <div id="project" className="mx-10 mt-4 mb-20 md:mx-16 ">
      ...
      <div className="lg:flex">
        ...
        <div className="md:flex  md:flex-col mt-8 lg:mt-0 md lg:w-1/2 ">
          {/* TITLE NAME*/}
          <h1 className="text-2xl  md:text-3xl lg:text-4xl text-secondary font-semibold  tracking-wide  text-white ">
            {name}
          </h1>
          {/* PROJECT DISCRIPTION PARAGRAPH */}
          <p className="md:my-auto text-[#7d7d7d]">{projectDiscription}</p>
        </div>
      </div>
