...
function ProjectSection() {
  ...
  return (
    <div className="bg-white bg-black mx-6 rounded-xl mt-8 md:mt-12  pb-4 md:pb-8 ">
      <div className="md:mx-32">
        <h1 className="mx-10 md:mb-16 pt-12 text-3xl md:text-5xl font-bold text-center text-purple_light tracking-wide">
          Projects
        </h1>
        <Project
